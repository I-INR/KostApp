                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade active show" id="kontak" role="tabpanel"
                            ...
                            <div class="card-body">
                                <form class="form form-horizontal" action="{{ route('user.contact.update') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control" placeholder="Name" name="nama"
                                                            id="first-name-icon" value="{{ $data->nama }}">
                                                        <div class="form-control-icon">
                                                            <i class="bi bi-person"></i>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="number" class="form-control" placeholder="Mobile" name="nomer" value="{{ $data->nomer }}">
                                                        <div class="form-control-icon" >
                                                            <i class="bi bi-phone"></i>
                                                        </div>
                                                    </div>
