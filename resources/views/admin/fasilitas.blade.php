    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <form action="{{ route('user.fasilitas.update') }}" method="POST">
                    @csrf
                                ...
                                <div class="form-group">
                                    <div class="form-group position-relative has-icon-left mb-4">
                                        ...
                                        <div class="form-control-icon">
                                            <input class="form-check-input  me-0" type="checkbox" name="kulkas"
                                                @if ($data->kulkas) checked @endif>
                                        </div>
                                    </div>
                                    <div class="form-group position-relative has-icon-left mb-4">
                                    ...
                                    <div class="form-group position-relative has-icon-left mb-4">
                                        <input type="text" class="form-control form-control-xl" placeholder="Dapur"
                                            disabled>
                                        <div class="form-control-icon">
                                            <input class="form-check-input  me-0" type="checkbox" name="dapur"
                                                @if ($data->dapur) checked @endif>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-group position-relative has-icon-left mb-4">
                                        ...
                                        <div class="form-control-icon">
                                            <input class="form-check-input  me-0" type="checkbox" name="kamarmandi"
                                                @if ($data->kamarmandi) checked @endif>
                                        </div>
                                    </div>
                                    <div class="form-group position-relative has-icon-left mb-4">
                                        <input type="text" class="form-control form-control-xl" placeholder="Kasur"
                                            disabled>
                                        <div class="form-control-icon">
                                            <input class="form-check-input  me-0" type="checkbox" name="kasur"
                                                @if ($data->kasur) checked @endif>
                                        </div>
                                    </div>
                                    <div class="form-group position-relative has-icon-left mb-4">
                                        <input type="text" class="form-control form-control-xl" placeholder="Lemari"
                                            disabled>
                                        <div class="form-control-icon">
                                            <input class="form-check-input  me-0" type="checkbox" name="lemari"
                                                @if ($data->lemari) checked @endif>
                                        </div>
                                    </div>
                                </div>
                            </div>
