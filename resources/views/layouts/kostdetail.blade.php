...
<head>
    <title>Kost {{ $datakost->namekost }}</title>
...
<body>
    ...
    <section class="about" style="margin-top: 30px;" id="about">
        <div class="container">
            <div class="heading">
                <h5>Jelajahi</h5>
                <h2>{{ $datakost->namekost }}
                </h2>
            </div>

            <div class="content flex  top">
                <div class="left">
                    <h3>{{ $datakost->namekost }}, salah satu kost terbaik yang bisa kamu dapatkan bersama kami</h3>
                    <p>{{ $datakost->deskriptions }}</p>
        ...
        <div class="container">
            ...
            <div class="content flex mtop">
                <div class="left grid2">
                    <div class=" box
              @if ($datafasilitas->kamarmandi == 0) invisible @endif
              ">
                        <i class="fas fa-desktop"></i>
                        <p>Gratis</p>
                        <h3>Kamar mandi dalam</h3>
                    </div>
                    <div class="box @if ($datafasilitas->kasur == 0)
                        invisible
                      @endif">
                    ...
                    <div class="box @if ($datafasilitas->kulkas == 0)
                        invisible
                      @endif">
                    ...
                    <div class="box @if ($datafasilitas->dapur == 0)
                        invisible
                      @endif">
                    ...
                    <div class="box @if ($datafasilitas->lemari == 0)
                        invisible
                      @endif">
                    ...
                    <div class="box @if ($datafasilitas->wifi == 0)
                        invisible
                      @endif">
